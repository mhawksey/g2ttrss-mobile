<?php define('DETECT_ARTICLE_LANGUAGE',false);?><?php
	// *******************************************
	...
	define('DB_USER', 'hawkseyi_ttrs1');
	define('DB_NAME', 'hawkseyi_ttrs1');
	define('DB_PASS', 'D)r3WsN^cP07*]7');
	...
	define('SELF_URL_PATH', 'https://hawksey.info/reader/');
...
define('_TRANSLATION_OVERRIDE_DEFAULT', 'en');
